...
export default function SSTooltip({
  ...
  return (
    <div className={clsx(className, "relative")}>
      ...
      <p
        role="tooltip"
        className="pointer-events-none absolute bottom-0 max-w-xs -translate-y-1/2 rounded-md bg-zinc-800 p-2 text-zinc-300 opacity-0 shadow transition-opacity group-hover:opacity-100 peer-hover:opacity-100 peer-focus:opacity-100 dark:bg-zinc-800"
      >
        {tooltip}
      </p>
    </div>
